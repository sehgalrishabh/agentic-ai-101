...
1. **Perception**: It gathers input from the user, data sources, or tools
2. **Reasoning**: It plans and decides what to do next
3. **Action**: It uses tools or APIs to do real work
4. **Feedback**: It evaluates results and continues or stops
...
- **Build as you learn**. Open the `code/` folder and follow each project step-by-step.
- **Keep a learning log**. Write down what confused you and what clicked.
